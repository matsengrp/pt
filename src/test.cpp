...
TEST_CASE("Partition", "[partition]") {
  auto p_DS1 = std::unique_ptr<Partition>(new Partition(
      "test-data/hohna_datasets_fasta/RAxML_bestTree.DS1", "test-data/hohna_datasets_fasta/DS1.fasta","test-data/hohna_datasets_fasta/RAxML_info.DS1"));
